...
适用于 Unity 2022.3.22f1、VRChat Worlds SDK 3.10.4 的 UdonSharp 基础系统。包含玩家资料、经验、TOTP 本地会话、自动位置识别、位置权限、直接传送与申请列表、楼层状态、电台值守和管理员操作。中文蓝色全息控制台按住 Tab 显示，松开隐藏。
...
4. 用 ClientSim 和至少两个 VRChat 客户端检查权限、位置自动更新、人数、传送申请与楼层状态。
